function SCR_screen() {
	...
	__view_set( e__VW.WView, view_current, screenWidth );
	__view_set( e__VW.HView, view_current, screenHeight );
	__view_set( e__VW.WPort, view_current, screenWidth*global.windowSize );
	__view_set( e__VW.HPort, view_current, screenHeight*global.windowSize );
